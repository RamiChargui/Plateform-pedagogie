...
<section class="section-padding course">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="cours.php" class="btn btn-main"> Inscrire au nouveau cours </a>
    ...
    //id courses for student
    
    $ids_courses= $user->monApprontissage($v_user_id);
    //
    
    if(empty($ids_courses)): ?>
    <h2>Aucun cours  </h2>
   <?php else:
        foreach($ids_courses as $id_cours ):
         
            $cours = new Cours();
            $le_cours=$cours->editBy($id_cours[0]);
        ?> 
                    ...
                    <div class="course-content">
                        ...
                        <div class="course-footer d-lg-flex align-items-center justify-content-between">
                            ...
                            <form action="detail_cours.php" method="POST">
                                ...
                                <img src="images/pencil.png" onclick="" alt="" style="width: 30px;height: 30px;" class="img-fluid">
                                </button>
                            </form>
