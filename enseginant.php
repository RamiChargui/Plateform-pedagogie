...
<section class="section-padding course">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    ...
                    <a href="ajouter_cours.php" class="btn btn-main">Nouveau cours </a>
    ...
    $cours = new Cours();
    $les_courses=$cours->editAll($v_user_id);
                    ...
                    <div class="course-content">
                        ...
                        <div class="course-footer d-lg-flex align-items-center justify-content-between">
                            <div class="course-meta">
                                <form action="edit_cours.php" method="POST">
                                    <input type="hidden" name="id_cours" value="<?=  $le_cours["id"]  ?>">
                                    <input type="hidden" name="nom" value="<?=  $le_cours["nom"]  ?>">
                                    <input type="hidden" name="image" value="<?=  $le_cours["image"]  ?>">
                                    <input type="hidden" name="description" value="<?=  $le_cours["description"] ?>">
                                    <input type="hidden" name="clef" value="<?=  $le_cours["clef"]  ?>">
                                <button type="submit" name="save" style="background-color: white;">
                                   <img src="images/pencil.png" onclick="" alt="" style="width: 20px;height: 20px;" class="img-fluid">
                                </button>
                            </form>
                            </div> 
                            ...
                            <form action="supprimer_cour.php" method="POST">
                                    <input type="hidden" name="id_cours" value="<?=  $le_cours["id"]  ?>">
                                    
                                <button type="submit" name="save" style="background-color: white;">
                                <img src="images/delete.png" alt="" style="width: 20px;height: 20px;" class="img-fluid">
                                </button>
                            </form>
