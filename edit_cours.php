...
//get cours
    ...
    if(isset($_POST['save'])){
        ...
        $v_cours_id = $_POST['id_cours'];
            ...
            $les_chapitres=$chapitre->editAll($v_cours_id);
...
<form  action="test.php" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" class="input-text form-control input-lg" id="fname" name="nom" value="<?=  $v_cours ?>" required><br>
    <label>image: </label><br>
    <img src="images/<?=  $v_image ?>">
  <input  class="input-text form-control input-lg" type="file" name="image" value="<?=  $v_image ?>" required></p>
 
  

  <p>
  <label>description: </label><br>
  <input class="input-text form-control input-lg"  type="text" name="description" value="<?=  $v_description ?>" required></p>
  <label>clef: </label><br>
  <input class="input-text form-control input-lg" type="text" name="clef" value="<?=  $v_clef ?>" required></p>

  <?php $x=1; foreach($les_chapitres as $le_chapitre ): ?> 
  <h3 style="">Chapitre <?=  $x ?>: </h3>
        <div class="row form-row" id="mydiv">
        
            <p class="form-row form-row-first form-group ">
                <label for="titre" class="control-label">titre&nbsp;</label>                                               
                <input type="text" class="input-text form-control input-lg" name="titre" id="titre"  value="<?=  $le_chapitre["titre"] ?>" required>                                                
            </p>
                                                
            <p class="form-row form-row-wide form-group " >
                <label for="file" class="control-label">fichier: <a href="files_db/<?=  $le_chapitre["fichier"] ?>"><?=  $le_chapitre["fichier"] ?></a></label>                                                
    ...
    <input type="submit" class="btn btn-main"   name="save" value="Ajouter">
  </form>                       
</div>                      
