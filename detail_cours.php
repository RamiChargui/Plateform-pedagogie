...
//get cours
    ...
    if(isset($_POST['save'])){
        ...
        $cours=new Cours();
         $v_id_cours = $_POST['id_cours'];
         $le_cours=$cours->editBy($v_id_cours);

         $chapitre = new Chapitre();
        $les_chapitres=$chapitre->editAll($v_id_cours);
...
<section class="section-padding course" >
    <div class="course-top-wrap" style="margin-right: 50px;" >
        <div class="container">
            <div class="row align-items-center" >
                <div class="col-lg-8">
                    <h3>Cours <?=  $le_cours["nom"]  ?> </h3>
                    <p>Cours <?=  $le_cours["description"]  ?> </p>
                </div>
  ...
  foreach($les_chapitres as $le_chapitre ):
...
?> 
 <div class="row">
    ...
    <div class="course-block course-style-2" style="padding: 10px;">
            <h4><?=  $le_chapitre["titre"]  ?></h4>
            <a href="files_db/<?=  $le_chapitre["fichier"]  ?>"><?=  $le_chapitre["fichier"]  ?></a>
